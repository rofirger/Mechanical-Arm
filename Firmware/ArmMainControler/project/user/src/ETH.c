...
uint8_t IPAddr[4] = {192,168,1,10};                                                                   /*IP地址*/
uint8_t GWIPAddr[4] = {192,168,1,1};                                                                  /*网关*/
uint8_t IPMask[4] = {255,255,255,0};                                                                  /*子网掩码*/
uint8_t DESIP[4] = {192,168,1,100};                                                                   /*目的IP地址*/

uint8_t SocketId;                                                                                     /*socket id号*/
uint8_t SocketRecvBuf[WCHNET_MAX_SOCKET_NUM][RECE_BUF_LEN];                                           /*socket缓冲区*/
uint8_t MyBuf[RECE_BUF_LEN];
uint16_t desport=1000;                                                                                /*目的端口号*/
uint16_t srcport=1000;                                                                                /*源端口号*/
